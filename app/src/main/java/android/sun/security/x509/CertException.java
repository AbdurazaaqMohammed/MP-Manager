...
public class CertException extends SecurityException {
    ...
    {
        return switch (verfCode) {
            case verf_INVALID_SIG -> "The signature in the certificate is not valid.";
            case verf_INVALID_REVOKED -> "The certificate has been revoked.";
            case verf_INVALID_NOTBEFORE -> "The certificate is not yet valid.";
            case verf_INVALID_EXPIRED -> "The certificate has expired.";
            case verf_CA_UNTRUSTED -> "The Authority which issued the certificate is not trusted.";
            case verf_CHAIN_LENGTH -> "The certificate path to a trusted authority is too long.";
            case verf_PARSE_ERROR -> "The certificate could not be parsed.";
            case err_CONSTRUCTION -> "There was an error when constructing the certificate.";
            case err_INVALID_PUBLIC_KEY -> "The public key was not in the correct format.";
            case err_INVALID_VERSION -> "The certificate has an invalid version number.";
            case err_INVALID_FORMAT -> "The certificate has an invalid format.";
            case err_ENCODING -> "Problem encountered while encoding the data.";
            default -> "Unknown code:  " + verfCode;
        };
    }
