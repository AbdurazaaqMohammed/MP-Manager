...
import com.reandroid.CommandExecutor;
...
public class Options {
    ...
    public void runCommand(APKLogger logger) throws IOException {
        CommandExecutor<?> executor = newCommandExecutor(logger);
        executor.logMessage(this.toString());
        executor.runCommand();
    }
    public CommandExecutor<?> newCommandExecutor(APKLogger logger) {
    ...
    public String toString() {
        ...
        builder.setTab2("      ");
        return "Using: " + ARSCLib.getName() + " version " + ARSCLib.getVersion() + "\n" + builder.buildTable();
    }
