...
public class InternalFrameworks extends FrameworkManager {
    ...
    private FrameworkApk loadResource(int version) throws IOException {
        ...
        try(InputStream is = FileUtils.getInputStream(path)) {
            return FrameworkApk.loadApkBuffer(simpleName, is);
        }
    }
    ...
    //FIX THIS
    private static final String ANDROID_RESOURCE_DIRECTORY = "/storage/emulated/0/MP Manager/frameworks/";
