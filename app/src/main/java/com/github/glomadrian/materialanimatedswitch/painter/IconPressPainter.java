...
public class IconPressPainter extends IconPainter {
  ...
  public IconPressPainter(Context context, Bitmap bitmap, BallFinishObservable ballFinishObservable,
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) initValueAnimator();
  ...
  private void initValueAnimator() {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB)   enterAnimator.addUpdateListener(new EnterValueAnimatorListener());

    exitAnimator = ValueAnimator.ofInt();
    exitAnimator.setDuration(exitAnimationDuration);
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB)  exitAnimator.addUpdateListener(new ExitValueAnimatorListener());
  }
