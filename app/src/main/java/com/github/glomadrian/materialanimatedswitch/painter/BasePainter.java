...
public class BasePainter implements SwitchInboxPinnedPainter, Observer {
  ...
  private void init() {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) initColorAnimator();
  ...
  @Override public void update(Observable observable, Object data) {
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB)
          colorAnimator.setCurrentPlayTime(((BallMoveObservable) observable).getBallAnimationValue());
  }
}