...
public class FileListAdapter extends BaseAdapter{
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        Animation animation = AnimationUtils.loadAnimation(context, MarkedItemList.hasItem(item.getLocation()) ? R.anim.marked_item_animation : R.anim.unmarked_item_animation);
        ...
        holder.fmark.setOnCheckedChangeListener((checkbox, isChecked) -> {
