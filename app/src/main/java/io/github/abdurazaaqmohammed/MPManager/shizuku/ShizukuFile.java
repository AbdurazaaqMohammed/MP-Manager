...
public class ShizukuFile extends File {
    ...
    public boolean isDirectory() {
        return directory || ShizukuShell.exec("[ -d " + RootManager.escapeShellArg(getAbsolutePath()) + " ]").success;
    }

    @Override
    public boolean isFile() {
        return !directory && ShizukuShell.exec("[ -f " + RootManager.escapeShellArg(getAbsolutePath()) + " ]").success;
    }
